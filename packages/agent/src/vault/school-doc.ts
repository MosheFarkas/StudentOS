...
const RESEARCH = [
  ...
  'running. Report it as MM-DD. Report null if you could not establish it from a source:',
  'a wrong date deletes classes a student is still taking, and a missing one falls back',
  'to a safe default.',
  '',
