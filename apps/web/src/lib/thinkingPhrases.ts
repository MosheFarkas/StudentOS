...
export const BASIC_PHRASES: readonly Phrase[] = [
  ...
  { text: 'Calculating…', themes: ['reasoning', 'time'] },
  ...
  { text: 'Computing…', themes: ['reasoning', 'time'] },
  ...
  { text: 'Structuring…', themes: ['writing', 'coursework', 'time'] },
  { text: 'Mapping…', themes: ['time', 'coursework', 'browsing', 'files'] },
  { text: 'Connecting…', themes: ['browsing', 'mail', 'reasoning', 'time'] },
  { text: 'Solving…', themes: ['reasoning', 'coursework'] },
  { text: 'Weighing…', themes: ['reasoning', 'time', 'coursework'] },
  { text: 'Deconstructing…', themes: ['reasoning', 'reading', 'coursework'] },
  { text: 'Cross-referencing…', themes: ['mail', 'coursework', 'files', 'time', 'browsing'] },
  { text: 'Optimizing…', themes: ['time', 'reasoning', 'writing'] },
  { text: 'Verifying…', themes: 'any' },
  { text: 'Balancing…', themes: ['time', 'reasoning', 'coursework'] },
...
export const NICHE_PHRASES: readonly Phrase[] = [
  ...
  { text: 'Mogging the problem…', themes: ['reasoning', 'coursework', 'time'] },
